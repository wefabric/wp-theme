        ...
        <div class="faq-drawer lg:px-0">
            @foreach($faqs as $key => $faq)
                <div class="bg-grey">
                    ...
                    <label class="faq-drawer__title relative block cursor-pointer text-md uppercase font-bold p-10 pb-7 lg:text-2xl" for="faq-drawer-{{$key}}">{{ $faq['question_and_answer']['question'] }}</label>
