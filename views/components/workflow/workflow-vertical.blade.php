            ...
            <div class="flex flex-col sm:flex-row pl-6 md:pl-8 items-start sm:items-center">
                ...
                @if ($stepImage)
                    <div class="flex-shrink-0">
                        <img src="{{ wp_get_attachment_image_url($stepImage, 'full') }}" alt="{{ get_post_meta($stepImage, '_wp_attachment_image_alt', true) }}"
                             class="object-cover md:w-60 rounded-{{ $borderRadius }}">
                    </div>
                @endif
