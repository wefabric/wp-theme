...
<div class="mobile block sm:hidden relative">
    @if($showSliderMobile)
        ...
        <div class="swiper-navigation w-full top-1/2 absolute">
            <div class="swiper-button-next package-button-next text-secondary hidden lg:block"></div>
            <div class="swiper-button-prev package-button-prev text-secondary hidden lg:block"></div>
        </div>
    @else
