            ...
            <div class="news-categories absolute z-20 top-[15px] left-[15px] flex flex-wrap gap-2">
                @if($postCategories)
                    @foreach ($postCategories as $category)
                        ...
                        @endphp
                        <div style="background-color: {{ $categoryColor }}" class="news-category @if(empty($categoryColor)) bg-primary @endif text-white px-4 py-2 rounded-full flex items-center gap-x-1">
