...
{{-- The following are for general blocks (#00 values), and some #50 values for images. --}}
        ...
        h-[150px] lg:h-[150px] max-h-[150px] lg:max-h-[150px]
        h-[200px] lg:h-[200px] max-h-[200px] lg:max-h-[200px]
        h-[225px] lg:h-[225px] max-h-[225px] lg:max-h-[225px]
        h-[250px] lg:h-[250px] max-h-[250px] lg:max-h-[250px]
        h-[300px] lg:h-[300px] max-h-[300px] lg:max-h-[300px]
        h-[350px] lg:h-[350px] max-h-[350px] lg:max-h-[350px]
