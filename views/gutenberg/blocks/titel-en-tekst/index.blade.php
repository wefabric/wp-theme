...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'titel-tekst' }}@endif" class="block-titel-tekst relative titel-tekst-{{ $randomNumber }}-custom-padding titel-tekst-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
