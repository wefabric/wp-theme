...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'uitgelicht-slider' }}@endif" class="block-uitgelicht-slider relative uitgelicht-slider-{{ $randomNumber }}-custom-padding uitgelicht-slider-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }}"
