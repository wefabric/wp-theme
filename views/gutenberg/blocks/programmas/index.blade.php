...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'programmas' }}@endif" class="block-programmas relative programmas-{{ $randomNumber }}-custom-padding programmas-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
