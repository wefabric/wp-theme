...
<section id="cta-werknemer" class="block-cta-werknemer relative cta-werknemer-{{ $randomNumber }}-custom-padding cta-werknemer-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }}"
