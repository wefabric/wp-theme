...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'cta-whitepaper' }}@endif" class="block-cta-whitepaper relative cta-whitepaper-{{ $randomNumber }}-custom-padding cta-whitepaper-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
