...
<section id="embed" class="block-embed relative embed-{{ $randomNumber }}-custom-padding embed-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
