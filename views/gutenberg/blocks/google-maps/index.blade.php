...
<section id="google-maps" class="block-google-maps relative google-maps-{{ $randomNumber }}-custom-padding google-maps-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }}"
