...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'google-maps' }}@endif" class="block-google-maps relative google-maps-{{ $randomNumber }}-custom-padding google-maps-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
...
<style>
    .google-maps-{{ $randomNumber }}-custom-padding {
