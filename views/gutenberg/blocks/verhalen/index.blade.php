...
<section id="verhalen" class="block-verhalen relative relative verhalen-{{ $randomNumber }}-custom-padding verhalen-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
