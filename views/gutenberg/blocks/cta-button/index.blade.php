...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'cta-button' }}@endif" class="block-cta-button relative cta-button-{{ $randomNumber }}-custom-padding cta-button-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
