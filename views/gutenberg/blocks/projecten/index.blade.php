...
<section id="projecten" class="block-projecten relative relative projecten-{{ $randomNumber }}-custom-padding projecten-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
