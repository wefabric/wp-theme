...
<section id="evenementen" class="block-evenementen relative evenementen-{{ $randomNumber }}-custom-padding evenementen-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
