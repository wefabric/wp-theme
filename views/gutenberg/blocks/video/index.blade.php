...
<section id="video" class="block-video block-{{ $randomNumber }} relative video-{{ $randomNumber }}-custom-padding video-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
