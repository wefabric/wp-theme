...
<section id="video-slider" class="block-video-slider relative video-slider-{{ $randomNumber }}-custom-padding video-slider-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
