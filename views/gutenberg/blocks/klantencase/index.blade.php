...
@if ($cases)
    <section id="klantencases" class="block-klantencases relative klantencases-{{ $randomNumber }}-custom-padding klantencases-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
