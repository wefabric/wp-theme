...
<section id="resultaten" class="block-resultaten relative resultaten-{{ $randomNumber }}-custom-padding resultaten-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
