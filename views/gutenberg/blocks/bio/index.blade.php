...
<section id="bio" class="block-bio block-{{ $randomNumber }} relative bio-{{ $randomNumber }}-custom-padding bio-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
