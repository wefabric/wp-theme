...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'medewerkersverhalen' }}@endif" class="block-medewerkersverhalen relative medewerkersverhalen-{{ $randomNumber }}-custom-padding medewerkersverhalen-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
...
<style>
    .medewerkersverhalen-{{ $randomNumber }}-custom-padding {
    ...
    .medewerkersverhalen-{{ $randomNumber }}-custom-margin {
        @media only screen and (min-width: 0px) {
