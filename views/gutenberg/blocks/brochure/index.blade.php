...
<section id="@if($customBlockId){{ $customBlockId }}@else{{ 'brochure' }}@endif" class="block-brochure relative brochure-{{ $randomNumber }}-custom-padding brochure-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
...
<style>
    .brochure-{{ $randomNumber }}-custom-padding {
    ...
    .brochure-{{ $randomNumber }}-custom-margin {
        @media only screen and (min-width: 0px) {
