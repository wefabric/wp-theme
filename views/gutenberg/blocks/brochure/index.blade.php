...
<section id="brochure" class="block-brochure relative brochure-{{ $randomNumber }}-custom-padding brochure-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
