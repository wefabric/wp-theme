...
<section id="delen" class="block-delen relative delen-{{ $randomNumber }}-custom-padding delen-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
