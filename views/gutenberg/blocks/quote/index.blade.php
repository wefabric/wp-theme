...
<section id="quote" class="block-quote relative quote-{{ $randomNumber }}-custom-padding quote-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
    ...
    <div class="relative z-10 px-8 py-8 lg:py-16 xl:py-20 {{ $fullScreenClass }}">
        <div class="{{ $blockClass }} {{ $textClass }} mx-auto">
            ...
            @if (($button1Text) && ($button1Link))
                <div class="{{ $textClass }} w-full flex flex-wrap gap-4 mt-4 md:mt-8">
