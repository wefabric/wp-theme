@php
    ...
    if ($displayType == 'show_all') {
        ...
        if(get_post()->post_type == 'vacatures') {
...
<section id="@if($customBlockId){{ $customBlockId }}@else vacatures @endif" class="block-vacatures relative vacatures-{{ $randomNumber }}-custom-padding vacatures-{{ $randomNumber }}-custom-margin bg-{{ $backgroundColor }} {{ $customBlockClasses }} {{ $hideBlock ? 'hidden' : '' }}"
