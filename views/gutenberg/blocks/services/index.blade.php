...
//    todo: Needs block update
    ...
    elseif ($displayType == 'show_specific') {
        $services = $block['data']['show_specific_services'];
...
<section id="@if($customBlockId){{ $customBlockId }}@else services @endif" class="block-services relative bg-{{ $backgroundColor }} {{ $customBlockClasses }}"
    ...
    <div class="relative z-10 px-8 py-8 lg:py-16 xl:py-20 {{ $fullScreenClass }}">
        <div class="{{ $blockClass }} mx-auto">
            ...
            @endif
            @if($services)
                @include('components.services.list', ['services' => $services])
            @endif
