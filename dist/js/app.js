...
/* harmony import */ var _wc_search__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./wc-search */ "./assets/js/wc-search.js");
/* harmony import */ var _wc_search__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_wc_search__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _wc_single_product__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wc-single-product */ "./assets/js/wc-single-product.js");
/* harmony import */ var _wc_single_product__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_wc_single_product__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _offer_dynamic_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./offer-dynamic-url */ "./assets/js/offer-dynamic-url.js");
/* harmony import */ var _offer_dynamic_url__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_offer_dynamic_url__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _dynamic_content__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dynamic-content */ "./assets/js/dynamic-content.js");
/* harmony import */ var _dynamic_content__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_dynamic_content__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _custom_cart__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./custom-cart */ "./assets/js/custom-cart.js");
/* harmony import */ var _custom_cart__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_custom_cart__WEBPACK_IMPORTED_MODULE_8__);
/* harmony import */ var _cad_download_toggle__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./cad-download-toggle */ "./assets/js/cad-download-toggle.js");
/* harmony import */ var _cad_download_toggle__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_cad_download_toggle__WEBPACK_IMPORTED_MODULE_9__);
...
swiper__WEBPACK_IMPORTED_MODULE_1__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_1__.Zoom]);
...
window.SwiperNavigation = swiper__WEBPACK_IMPORTED_MODULE_1__.Navigation;
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start();

/***/ }),

/***/ "./assets/js/cad-download-toggle.js":
/*!******************************************!*\
  !*** ./assets/js/cad-download-toggle.js ***!
  \******************************************/
...
jQuery(function ($) {
  $('.cad-downloads-toggle').click(function () {
    var downloadsList = $('.downloads-list');
    var cadDownloadToggle = $('.cad-downloads-toggle');
...
/***/ "./assets/js/offer-dynamic-url.js":
/*!****************************************!*\
  !*** ./assets/js/offer-dynamic-url.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
jQuery(document).ready(function ($) {
  $('.offer-dynamic-url').click(function (e) {
    ...
    var quantity = (_$$val = $('.quantity .qty').val()) !== null && _$$val !== void 0 ? _$$val : 1;
    if (sku) {
      e.preventDefault();
...
jQuery(document).ready(function ($) {
  $('.product-search-filter-terms ul').each(function () {
    ...
    if ($(this).find("li").length > max) {
      var item = $(this);
      item.find('li:gt(' + max + ')').hide().end().append($(showMoreHtml).click(function () {
        if ($(this).hasClass('show-items')) {
          $(this).siblings('.attribute-item:gt(' + max + ')').hide().end().toggleClass('show-items').html('<i class="fa-solid fa-chevron-down pr-2"></i> Bekijk meer...');
        } else {
          $(this).siblings('.attribute-item').show().end().toggleClass('show-items').html('<i class="fa-solid fa-chevron-up pr-2"></i> Bekijk minder...');
        }
      }));
    }
  });
...
/***/ "./assets/js/wc-single-product.js":
/*!****************************************!*\
  !*** ./assets/js/wc-single-product.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __unused_webpack_exports, __webpack_require__) => {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkwefabric_theme"] = self["webpackChunkwefabric_theme"] || [];
